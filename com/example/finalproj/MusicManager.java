...
public class MusicManager {
	...
	public static void start(Context context, int music, boolean force) {
	 ...
	 if (music == MUSIC_MENU) {
	 mp = MediaPlayer.create(context, R.raw.bgpuzzle);//bgpuzzle
	 } else if (music == MUSIC_GAME) {
	 mp = MediaPlayer.create(context, R.raw.pzlbgm);
...
*/
	public static void stopper(int music) {
	...
	public static void release(int music) {
	 //Log.d(TAG, "Releasing media players");
	 //Collection mps = players.values();
	 MediaPlayer mp = (MediaPlayer) players.get(music);
	 //for (MediaPlayer mp : mps) {
